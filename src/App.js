...
const App = () => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Image style={styles.instagramLogo} source={require('./images/instagramTextLogo.png')} />

      <View style={styles.input1}>
        <TextInput placeholder='Phone number, username or email' style={{fontSize:10, padding: 0, marginLeft:5}} keyboardType='email-address'></TextInput>
      </View>

      <View style={styles.input2}>
        <TextInput placeholder='Password' style={{fontSize:10, padding: 0, marginLeft: 5}}></TextInput>
      </View>
      ...
      <View style={styles.facebook}>
        <Image style={styles.facebookImg} source={require('./images/facebook.png')} />
      ...
      <View style={styles.stores}>
        <Image style={styles.store} source={require('./images/appStore.png')}/>

        <Image style={styles.store} source={require('./images/playStore.png')} />
      </View>
